                        ...
                        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div id="single-carousel">
                                                <div class="img-hover">
                                                    <img src="{{asset('images/services')}}/{{$service->name}}" alt="{{$service->name}}" class="img-responsive">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">Detalhes de Contratação</div>
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    <td style="border-top: none;">Preço</td>
                                                    <td style="border-top: none;"><span>R&#36;:</span> {{$service->price}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Quantidade</td>
                                                    <td>1</td>
                                                ...
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>R&#36;:</span> {{$total}}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="panel-footer">
                                            <form>                                                
                                                <input type="submit" class="btn btn-primary" name="submit" value=" Contratar">
                                            </form>
                                        </div>
                                    </div>
                                </aside>
                                            ...
                                            <a href="{{route('home.service_details',['service_slug'=>$r_service->slug])}}">
                                                ...
                                                <div class="info-gallery">
                                                    ...
                                                    <div class="content-btn">
                                                        <a href="{{route('home.service_details',['service_slug'=>$r_service->slug])}}" class="btn btn-warning">
                                                            Detalhes
                                                        </a>
                                                    </div>
                                                    <div class="price"><span>&#36;</span><b>Por</b>{{$r_service->price}}</div>
                                                </div>
                                            </a>
                                        </div>
                                    @endif
