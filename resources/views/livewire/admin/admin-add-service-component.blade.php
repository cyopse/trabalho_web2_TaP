                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="createService">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="control-label col-sm-3">Nome do Serviço</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="slug" class="control-label col-sm-3">Referencia do Serviço</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="tagline" class="control-label col-sm-3">Tag</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="slug" class="control-label col-sm-3">Categoria do Serviço</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="price" class="control-label col-sm-3">Preço</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="discount" class="control-label col-sm-3">Desconto</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="discount" class="control-label col-sm-3">Tipo de desconto</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="inclusion" class="control-label col-sm-3">Inclusão</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="exclusion" class="control-label col-sm-3">Exclusão</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="image" class="control-label col-sm-3">Foto do Serviço</label>
                                            <div class="col-sm-9">
                                        ...
                                        <button type="submit" class="btn btn-success pull-right">Criar Serviço</button>
                                    </form>
                                </div>
                            </div>
                        </div>
