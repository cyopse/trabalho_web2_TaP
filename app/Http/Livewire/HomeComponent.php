...
class HomeComponent extends Component
{
    public function render()
    {
        ...
        $sid = ServiceCategory::whereIn('slug',['eletrica', 'ar-condicionado', 'chuveiros', 'manutencao-de-computadores', 'tv', 'geladeiras', 'carros', 'automacao-residencial'])->get()->pluck('id');
